                ...
                <div className="md:col-span-1 bg-white p-4 shadow rounded border-none ">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <select name="type" value={filters.type} onChange={handleFilterChange} className="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-pink-400">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-2">
                                <input type="number" name="ageMin" value={filters.ageMin} onChange={handleFilterChange} className="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-pink-400" placeholder="Min" />
                                <span>-</span>
                                <input type="number" name="ageMax" value={filters.ageMax} onChange={handleFilterChange} className="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-pink-400" placeholder="Max" />
                            </div>
                        </div>
                    </div>
                </div>
